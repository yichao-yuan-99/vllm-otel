...
DEFAULT_OUTPUT_CONFIG_DIR = (
    REPO_ROOT
    / "experiments"
    / "sweep-qps-docker-power-clean-gateway_multi-lowest_usage_freq_ctrl_linespace-slo"
    / "generated"
)
...
EXPERIMENT_DIR_NAME = "sweep-qps-docker-power-clean-gateway_multi-lowest_usage_freq_ctrl_linespace-slo"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "clean split plan, forcing assignment policy lowest_usage, and "
