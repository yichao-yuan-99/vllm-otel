...
def load_generator_module() -> object:
    ...
    spec = importlib.util.spec_from_file_location(
        (
            ...
            "lowest_profile_without_pending_freq_ctrl_linespace_experiment"
        ),
        module_path,
    )
...
def test_main_generates_sweep_qps_docker_power_clean_gateway_multi_lowest_profile_without_pending_freq_ctrl_linespace_bundle(
    tmp_path: Path,
) -> None:
...
def test_main_supports_repeated_port_profile_flags_custom_thresholds_and_suffix(
    tmp_path: Path,
) -> None:
