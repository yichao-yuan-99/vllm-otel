...
1. Profiles `0,1,2,3,4` are up and serving the same Qwen3-235B-FP8 model.
...
```bash
python experiments/qwen3-235b-fp8/start.py \
...
bash experiments/qwen3-235b-fp8/batch_benchmarks.sh \
  --per-profile-conc 5
```
...
`experiments/results/qwen3-235b-fp8/<benchmark>/<agent>/`

Default roots:

- `experiments/results/qwen3-235b-fp8/swebench-verified/mini-swe-agent/`
- `experiments/results/qwen3-235b-fp8/swebench-verified/terminus-2/`
- `experiments/results/qwen3-235b-fp8/terminal-bench-2.0/mini-swe-agent/`
- `experiments/results/qwen3-235b-fp8/terminal-bench-2.0/terminus-2/`
- `experiments/results/qwen3-235b-fp8/livecodebench/mini-swe-agent/`
- `experiments/results/qwen3-235b-fp8/livecodebench/terminus-2/`
- `experiments/results/qwen3-235b-fp8/dabstep/mini-swe-agent/`
- `experiments/results/qwen3-235b-fp8/dabstep/terminus-2/`
