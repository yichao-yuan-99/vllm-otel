...
EXPERIMENT_DIR_NAME = "sweep-qps-docker-power-clean-freq-ctrl-linespace-sweep-slo-og"
...
def write_replay_config(path: Path, *, replay_payload: dict[str, Any]) -> None:
    lines: list[str] = [
        (
            "# Auto-generated by "
            "experiments/sweep-qps-docker-power-clean-freq-ctrl-linespace-sweep-slo-og/"
            "generate_experiment.py"
        ),
        "",
    ]
