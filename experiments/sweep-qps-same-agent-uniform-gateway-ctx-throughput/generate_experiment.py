...
EXPERIMENT_DIR_NAME = "sweep-qps-same-agent-uniform-gateway-ctx-throughput"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "ctx-aware throughput mode from one precompiled derived single-trail "
            "replay plan and emit one sweep entrypoint script."
        ),
    )
    parser.add_argument(
        "--source-plan",
