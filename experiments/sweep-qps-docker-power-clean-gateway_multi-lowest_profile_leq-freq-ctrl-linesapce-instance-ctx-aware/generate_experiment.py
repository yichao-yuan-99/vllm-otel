#!/usr/bin/env python3
"""Generate one local sweep-QPS + power logging + gateway_multi lowest_profile_leq instance replay bundle."""
...
DEFAULT_ASSIGNMENT_POLICY = "lowest_profile_leq"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "split plan, forcing assignment policy lowest_profile_leq with a "
            "configurable balanced usage threshold, enabling ctx-aware mode, and starting one "
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Threshold sent to gateway_multi policy update for lowest_profile_leq. "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/"
            "sweep-qps-docker-power-clean-gateway_multi-lowest_profile_leq-freq-ctrl-linesapce-instance-ctx-aware-lmcache/."
        ),
    )
    return parser
