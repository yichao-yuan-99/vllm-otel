#!/usr/bin/env python3
"""Generate one local sweep-QPS + power logging + gateway_multi instance replay bundle."""
...
DEFAULT_OUTPUT_CONFIG_DIR = (
    REPO_ROOT
    / "experiments"
    / "sweep-qps-docker-power-clean-gateway_multi-freq-ctrl-linesapce-instance-ctx-aware"
    / "generated"
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/"
            "sweep-qps-docker-power-clean-gateway_multi-freq-ctrl-linesapce-instance-ctx-aware-lmcache/."
        ),
    )
    return parser
