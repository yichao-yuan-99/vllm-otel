#!/usr/bin/env python3
"""Generate one local sweep-QPS + power logging + gateway_multi lowest-usage instance replay bundle."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "split plan, forcing assignment policy lowest_usage, enabling "
            "ctx-aware mode, and starting one "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/"
            "sweep-qps-docker-power-clean-gateway_multi-lowest_usage-freq-ctrl-linesapce-instance-ctx-aware-lmcache/."
        ),
    )
    return parser
