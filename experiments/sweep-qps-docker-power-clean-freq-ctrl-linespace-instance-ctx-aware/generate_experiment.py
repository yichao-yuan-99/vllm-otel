#!/usr/bin/env python3
"""Generate one local sweep-QPS + power logging + linespace-instance ctx-aware bundle."""
...
EXPERIMENT_DIR_NAME = "sweep-qps-docker-power-clean-freq-ctrl-linespace-instance-ctx-aware"
...
def write_replay_config(path: Path, *, replay_payload: dict[str, Any]) -> None:
    lines: list[str] = [
        (
            "# Auto-generated by "
            "experiments/sweep-qps-docker-power-clean-freq-ctrl-linespace-instance-ctx-aware/"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "gateway ctx-aware mode plus freq-controller-linespace-instance by "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/sweep-qps-docker-power-clean-freq-ctrl-linespace-instance-ctx-aware-<threshold>/. "
