#!/usr/bin/env python3
"""Generate one local sweep-QPS + power logging + gateway_multi lowest_profile_leq_reloc_2 instance replay bundle."""
...
DEFAULT_ASSIGNMENT_POLICY = "lowest_profile_leq_reloc_2"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "split plan, forcing assignment policy lowest_profile_leq_reloc_2 with a "
            "configurable balanced usage threshold, enabling ctx-aware mode, and "
            "starting one freq-controller-linespace-instance controller per backend GPU."
        ),
    )
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Threshold sent to gateway_multi policy update for lowest_profile_leq_reloc_2. "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/"
            "sweep-qps-docker-power-clean-gateway_multi-lowest_profile_leq_reloc_2-freq-ctrl-linesapce-instance-ctx-aware-lmcache/."
        ),
    )
    return parser
