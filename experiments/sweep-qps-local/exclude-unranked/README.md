# Sweep QPS Local (Exclude-Unranked Single Profile)
...
It is the same shape as `sweep-qps-local/single`, but defaults to:
...
- source: `experiments/sweep-qps-local/exclude-unranked/generated/<utc-timestamp>/`
- destination: `results/replay/<utc-timestamp>/generated/`

## Generate Experiments

```bash
python3 experiments/sweep-qps-local/exclude-unranked/generate_replay_configs.py \
...
- `experiments/sweep-qps-local/exclude-unranked/generated/<utc-timestamp>/`
...
```bash
sbatch experiments/sweep-qps-local/exclude-unranked/generated/<utc-timestamp>/qps0_1/sbatch.sh
```

Or submit the whole batch:

```bash
bash experiments/sweep-qps-local/exclude-unranked/generated/<utc-timestamp>/submit_all.sh
```
...
- `--exclude-unranked-plan` is enabled by default in this variant.
