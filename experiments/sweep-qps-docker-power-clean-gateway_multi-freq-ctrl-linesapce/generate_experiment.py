...
DEFAULT_OUTPUT_CONFIG_DIR = (
    REPO_ROOT
    / "experiments"
    / "sweep-qps-docker-power-clean-gateway_multi-freq-ctrl-linesapce"
    / "generated"
)
...
EXPERIMENT_DIR_NAME = "sweep-qps-docker-power-clean-gateway_multi-freq-ctrl-linesapce"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/"
            "sweep-qps-docker-power-clean-gateway_multi-freq-ctrl-linesapce-lmcache/."
        ),
    )
    return parser
