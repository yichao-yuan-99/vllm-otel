#!/usr/bin/env python3
"""Generate one dedicated mi2104x embedded TP1 AMD freq-control sweep bundle."""
...
_BASE_GENERATOR_MODULE_NAME = (
    "generate_sweep_qps_docker_power_clean_experiment_for_mi2104x_embedded_tp1_freq_ctrl_linespace_amd"
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Generate a dedicated mi2104x embedded TP1 AMD sweep-QPS replay bundle "
