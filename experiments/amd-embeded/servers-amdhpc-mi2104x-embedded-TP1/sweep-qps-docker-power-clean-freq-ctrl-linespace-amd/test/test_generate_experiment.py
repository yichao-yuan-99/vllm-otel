...
def load_generator_module() -> object:
    ...
    spec = importlib.util.spec_from_file_location(
        "generate_amd_mi2104x_embedded_tp1_sweep_qps_freq_ctrl_linespace_amd_experiment",
        module_path,
    )
...
def test_main_generates_mi2104x_amd_freq_ctrl_bundle(tmp_path: Path) -> None:
    ...
    assert (
        "[amd-embeded-servers-amdhpc-mi2104x-embedded-TP1-sweep-qps-docker-power-clean-freq-ctrl-linespace-amd]"
        in run_script_text
    )
