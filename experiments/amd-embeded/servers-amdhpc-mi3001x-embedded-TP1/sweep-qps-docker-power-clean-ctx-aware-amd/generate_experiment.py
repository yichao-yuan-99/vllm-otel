#!/usr/bin/env python3
"""Generate one single-node mi3001x embedded TP1 AMD ctx-aware sweep-QPS bundle."""
...
_BASE_GENERATOR_MODULE_NAME = (
    "generate_sweep_qps_docker_power_clean_ctx_aware_experiment_for_mi3001x_embedded_tp1_amd"
)
