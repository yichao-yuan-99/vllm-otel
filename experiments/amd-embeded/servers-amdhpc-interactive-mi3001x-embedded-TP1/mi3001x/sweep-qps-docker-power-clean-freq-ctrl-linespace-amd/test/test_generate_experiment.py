...
def load_generator_module() -> object:
    ...
    spec = importlib.util.spec_from_file_location(
        "generate_amd_interactive_mi3001x_sweep_qps_freq_ctrl_linespace_amd_experiment",
        module_path,
    )
...
def test_main_generates_interactive_amd_freq_ctrl_bundle(tmp_path: Path) -> None:
    ...
    assert "interactive_embedded_tp1_resolve_gateway_base_url" in run_script_text
    ...
    assert "resolve_gateway_base_url() {" not in run_script_text
