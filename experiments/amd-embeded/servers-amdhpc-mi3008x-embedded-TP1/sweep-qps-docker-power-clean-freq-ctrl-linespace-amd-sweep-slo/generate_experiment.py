...
EXPERIMENT_DIR_NAME = "sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo"
...
EXPERIMENT_LOG_TAG = (
    ...
    "sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo"
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "QPS points are assigned to port profiles 0..7 in ascending order; "
            "SLO values run as sequential rounds inside the selected QPS slot."
        ),
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "amd-embeded/servers-amdhpc-mi3008x-embedded-TP1/"
            "sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo-lmcache/."
        ),
    )
    return parser
