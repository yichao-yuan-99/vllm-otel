# Embedded AMD HPC TP1 MI3008X Sweep QPS Power Clean Freq Ctrl Linespace AMD Sweep SLO Aggressive
...
- `freq-controller-linespace-slo-amd --aggresive`
...
- the generated frequency-controller command always enables aggressive SLO mode
...
```bash
python3 experiments/amd-embeded/servers-amdhpc-mi3008x-embedded-TP1/sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo-aggressive/generate_experiment.py \
...
```bash
bash experiments/amd-embeded/servers-amdhpc-mi3008x-embedded-TP1/sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo-aggressive/generated/<timestamp>/run_replay.sh
```
...
```bash
bash experiments/amd-embeded/servers-amdhpc-mi3008x-embedded-TP1/sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo-aggressive/generated/<timestamp>/submit_embedded_tp1.sh
```
...
python3 servers/servers-amdhpc-mi3008x-embedded-TP1/launch.py submit \
  ...
  -e ./experiments/amd-embeded/servers-amdhpc-mi3008x-embedded-TP1/sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo-aggressive/generated/<timestamp>/run_replay.sh
```

Default replay output layout:

- `results/replay/amd-embeded/servers-amdhpc-mi3008x-embedded-TP1/sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo-aggressive<suffix>/<dataset>/<agent>/split/<split>/<qps>/<slo>/<timestamp>/profile-<assigned-profile>/`
...
```bash
pytest experiments/amd-embeded/servers-amdhpc-mi3008x-embedded-TP1/sweep-qps-docker-power-clean-freq-ctrl-linespace-amd-sweep-slo-aggressive/test -q
```
