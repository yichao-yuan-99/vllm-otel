#!/usr/bin/env python3
"""Generate one dedicated mi2508x embedded TP2 AMD sweep-QPS power bundle."""
...
_BASE_GENERATOR_MODULE_NAME = (
    "generate_sweep_qps_docker_power_clean_experiment_for_mi2508x_embedded_tp2_amd"
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Generate a dedicated mi2508x embedded TP2 sweep-QPS replay bundle "
