#!/usr/bin/env python3
"""Generate one local sweep-QPS + sweep-SLO + power logging + gateway-only SLO-aware bundle."""
...
EXPERIMENT_DIR_NAME = "sweep-qps-docker-power-clean-freq-ctrl-linespace-sweep-slo-og-80p"
...
SLO_AWARE_POLICY_MODE = "push-back-80p-slack"
...
DEFAULT_FREQ_CONTROLLER_BIN = "freq-controller-linespace"
...
def write_replay_config(path: Path, *, replay_payload: dict[str, Any]) -> None:
    lines: list[str] = [
        (
            "# Auto-generated by "
            "experiments/sweep-qps-docker-power-clean-freq-ctrl-linespace-sweep-slo-og-80p/"
            "generate_experiment.py"
        ),
        "",
    ]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "freq-controller-linespace, and gateway-only SLO-aware mode by "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "e.g. 8,10,12. The same values are sent to gateway slo-aware mode "
            "for each replay job."
        ),
    )
    parser.add_argument(
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        summary = {
            ...
            "slo_targets_drive_gateway_only": True,
            "slo_targets_drive_gateway_and_freq_controller": False,
            "freq_controller_uses_slo_target": False,
            "freq_controller_threshold": threshold_value,
