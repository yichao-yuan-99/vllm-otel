#!/usr/bin/env python3
"""Generate one local sweep-QPS + power logging + linespace-instance bundle."""
...
DEFAULT_REPLAY_OUTPUT_ROOT_NAME = "sweep-qps-docker-power-clean-freq-ctrl-linespace-instance"
...
EXPERIMENT_DIR_NAME = "sweep-qps-docker-power-clean-freq-ctrl-linespace-instance"
...
def write_run_script(
    ...
    *,
    ...
    lines = [
        ...
        "",
        f"  echo \"[{EXPERIMENT_LOG_TAG}] split={split} qps=${{qps_value}} slug=${{qps_slug}} gpu_id={gpu_id} threshold=${{FREQ_CONTROLLER_THRESHOLD_VALUE}} output=${{replay_output_ref}} port_profile=${{PORT_PROFILE_ID_VALUE}}\"",
        ...
        (
            ...
            "freq-controller-linespace-instance failed to stay alive after startup\" >&2"
        ),
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "freq-controller-linespace-instance by looking up an existing compiled clean "
    ...
    parser.add_argument(
        ...
        help="GPU index used by both freq-controller-linespace-instance and zeus-power-reader.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/sweep-qps-docker-power-clean-freq-ctrl-linespace-instance-<threshold>/. "
