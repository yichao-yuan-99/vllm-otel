#!/usr/bin/env python3
"""Generate one local sweep-QPS + power logging + explicit gateway_multi round_robin replay bundle."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "split plan, forcing assignment policy round_robin, enabling "
            "ctx-aware mode, and "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "results/replay/"
            "sweep-qps-docker-power-clean-gateway_multi-round_robin-freq-ctrl-linesapce-instance-ctx-aware-lmcache/."
        ),
    )
    return parser
