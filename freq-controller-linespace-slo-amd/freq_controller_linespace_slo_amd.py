    ...
    def to_log_payload(
        ...
        *,
        ...
        return {
            ...
            "aggressive_slo_control": self.aggressive_slo_control,
...
def choose_next_frequency_index(
    *,
    ...
    if (
        ...
        if aggressive_slo_control:
            return max_index, "increase_for_slo"
        return min(max_index, current_index + 1), "increase_for_slo"
...
class FrequencyController:
    ...
    def _control_once(self, now_s: float) -> None:
        ...
        next_index, action = choose_next_frequency_index(
            ...
            aggressive_slo_control=self.config.aggressive_slo_control,
        )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "If the observed value is lower, the controller forces an upward "
            "frequency step. Required unless configured in TOML."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--aggresive",
        "--aggressive",
        dest="aggressive_slo_control",
        action="store_true",
        help=(
            "When throughput SLO is violated, jump directly to the highest "
            "configured frequency instead of increasing by one step."
        ),
    )
