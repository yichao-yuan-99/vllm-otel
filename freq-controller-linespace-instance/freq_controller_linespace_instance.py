#!/usr/bin/env python3
"""Linespace instance GPU frequency controller driven by gateway context usage."""
...
DEFAULT_LOG_FILE_PREFIX = "freq-controller-ls-instance"
...
def choose_next_frequency_index(
    *,
    ...
    # Unlike the baseline controller, the instance variant applies the chosen
    # target segment immediately instead of ramping one frequency step at a time.
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="freq-controller-linespace-instance",
        description=(
            "Control GPU core frequency from gateway context usage using a "
            "single linespace threshold, direct target-frequency jumps, and zeusd."
        ),
    )
    parser.add_argument(
        "--config",
    ...
    try:
        ...
        print(
            (
                "freq-controller-linespace-instance logs: "
