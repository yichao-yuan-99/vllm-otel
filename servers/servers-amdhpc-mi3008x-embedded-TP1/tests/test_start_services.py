#!/usr/bin/env python3
"""Smoke tests for the mi3008x embedded TP1 launcher script/docs."""
...
class StartServicesScriptTest(unittest.TestCase):
    ...
    def test_readme_documents_embedded_batch_workflow(self) -> None:
        ...
        self.assertIn("python3 servers/servers-amdhpc-mi3008x-embedded-TP1/launch.py render", readme_text)
        self.assertIn("python3 servers/servers-amdhpc-mi3008x-embedded-TP1/launch.py submit", readme_text)
