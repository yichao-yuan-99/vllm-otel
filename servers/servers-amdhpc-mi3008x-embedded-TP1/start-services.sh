...
JOB_LOG_DIR="${JOB_LOG_DIR:-${REPO_ROOT}/servers/servers-amdhpc-mi3008x-embedded-TP1/logs}"
...
echo "MI3008X embedded TP1 service stack starting on $(hostname) at $(date)"
echo "Run ID: ${RUN_ID}"
resolve_model_launch_settings
load_vllm_extra_env_args
