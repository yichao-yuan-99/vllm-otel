...
#SBATCH --output=/srv/local/scratch/yichaoy2/work/vllm-otel/servers/servers-amdhpc-embedded-TP1/logs/slurm.%j.out
#SBATCH --error=/srv/local/scratch/yichaoy2/work/vllm-otel/servers/servers-amdhpc-embedded-TP1/logs/slurm.%j.err
#SBATCH --nodes=1
...
REPO_ROOT=/srv/local/scratch/yichaoy2/work/vllm-otel
cd "${REPO_ROOT}"

EXPERIMENT_SCRIPT=/srv/local/scratch/yichaoy2/work/vllm-otel/servers/servers-amdhpc-embedded-TP1/README.md
...
JAEGER_SIF=/home/yichaoy2/apptainer-images/all-in-one-1.57.sif
VLLM_SIF=/home/yichaoy2/apptainer-images/vllm-vllm-openai-rocm:v0.17.1-otel-lp-rocm-lmcache-gfx942.sif
VLLM_MODEL_NAME=Qwen/Qwen3-Coder-30B-A3B-Instruct
VLLM_SERVED_MODEL_NAME=Qwen3-Coder-30B-A3B-Instruct
VLLM_TENSOR_PARALLEL_SIZE=1

VLLM_APPTAINER_HOME=''
HF_HOME=/srv/local/scratch/yichaoy2/huggingface
HF_HUB_CACHE=/srv/local/scratch/huggingface/hub
HF_HUB_OFFLINE=1
TRANSFORMERS_OFFLINE=1
HF_TOKEN="${HF_TOKEN:-}"
export HF_HUB_OFFLINE TRANSFORMERS_OFFLINE

AITER_JIT_DIR=/tmp/vllm-aiter-jit-yichaoy2
XDG_CACHE_HOME=/tmp/vllm-runtime-yichaoy2/xdg-cache
VLLM_CACHE_ROOT=/tmp/vllm-runtime-yichaoy2/xdg-cache/vllm
...
GATEWAY_CONFIG_DEFAULT=/srv/local/scratch/yichaoy2/work/vllm-otel/gateway/config.toml
GATEWAY_CONFIG_FALLBACK=/srv/local/scratch/yichaoy2/work/vllm-otel/gateway/config.example.toml
GATEWAY_VENV_DIR="${GATEWAY_VENV_DIR:-/srv/local/scratch/yichaoy2/work/vllm-otel/.venv}"
GATEWAY_HOST="${GATEWAY_HOST:-127.0.0.1}"
GATEWAY_SKIP_INSTALL="${GATEWAY_SKIP_INSTALL:-1}"

JOB_LOG_DIR=/srv/local/scratch/yichaoy2/work/vllm-otel/servers/servers-amdhpc-embedded-TP1/logs
...
launch_vllm 1 24123 29437 1
launch_vllm 2 31987 29459 2
launch_vllm 3 40823 29483 3
launch_vllm 4 52341 29507 4
launch_vllm 5 59231 29531 5
launch_vllm 6 60231 29557 6
launch_vllm 7 61231 29579 7
wait_for_vllm_ready 0 11451
wait_for_vllm_ready 1 24123
wait_for_vllm_ready 2 31987
wait_for_vllm_ready 3 40823
wait_for_vllm_ready 4 52341
wait_for_vllm_ready 5 59231
wait_for_vllm_ready 6 60231
wait_for_vllm_ready 7 61231
launch_gateway 0 11457 18171
launch_gateway 1 24157 28171
launch_gateway 2 31955 38171
launch_gateway 3 40857 48171
launch_gateway 4 52357 58171
launch_gateway 5 59257 59171
launch_gateway 6 60257 60171
launch_gateway 7 61257 61171
wait_for_gateway_ready 0 11457 18171
wait_for_gateway_ready 1 24157 28171
wait_for_gateway_ready 2 31955 38171
wait_for_gateway_ready 3 40857 48171
wait_for_gateway_ready 4 52357 58171
wait_for_gateway_ready 5 59257 59171
wait_for_gateway_ready 6 60257 60171
wait_for_gateway_ready 7 61257 61171
launch_experiment 0
launch_experiment 1
launch_experiment 2
launch_experiment 3
