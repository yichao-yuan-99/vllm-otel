#!/usr/bin/env python3
"""Resolve mi2508x embedded TP2 launcher model settings from configs/model_config.toml."""
...
DEFAULT_TP2_EXTRA_ARGS = ["--trust-remote-code"]
    ...
    *,
    ...
    if spec is None:
        ...
        return ResolvedModelLaunchConfig(
            ...
            or _encode_model_extra_args(DEFAULT_TP2_EXTRA_ARGS),
        )
    ...
    return ResolvedModelLaunchConfig(
        ...
        model_extra_args_b64=cleaned_extra_args_b64
        or _encode_model_extra_args(_normalize_tp2_extra_args(spec.extra_args)),
    )
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "used by the mi2508x embedded TP2 launcher."
        )
    )
