#!/usr/bin/env bash
#SBATCH --job-name=vllm_embedded_tp2_mi2508x_tp2
#SBATCH --output=/work1/talati/yichaoy/vllm-otel/servers/servers-amdhpc-mi2508x-embedded-TP2/logs/slurm.%j.out
#SBATCH --error=/work1/talati/yichaoy/vllm-otel/servers/servers-amdhpc-mi2508x-embedded-TP2/logs/slurm.%j.err
#SBATCH --nodes=1
...
export EXPERIMENT_SCRIPT=/work1/talati/yichaoy/vllm-otel/experiments/amd-embeded/servers-amdhpc-mi2508x-embedded-TP2/mi2508x/sweep-qps-docker-power-clean-freq-ctrl-linespace-amd/generated/20260410T001051Z/run_replay.sh
export VLLM_MODEL_KEY=qwen3_coder_30b
...
bash /work1/talati/yichaoy/vllm-otel/servers/servers-amdhpc-mi2508x-embedded-TP2/start-services.sh
