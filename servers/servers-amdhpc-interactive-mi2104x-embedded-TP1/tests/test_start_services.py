#!/usr/bin/env python3
"""Smoke tests for the interactive mi2104x embedded TP1 launcher script/docs."""
...
class StartServicesScriptTest(unittest.TestCase):
    ...
    def test_start_services_unrolls_all_mi2104x_profiles(self) -> None:
        script_text = START_SCRIPT.read_text(encoding="utf-8")

        self.assertIn("PROFILE_IDS=(0 1 2 3)", script_text)
        self.assertIn('local selector="${VLLM_MODEL_KEY:-${VLLM_MODEL_NAME:-qwen3_14b}}"', script_text)
    ...
    def test_readme_documents_mi2104x_stack(self) -> None:
        ...
        self.assertIn("qwen3_14b", readme_text)
