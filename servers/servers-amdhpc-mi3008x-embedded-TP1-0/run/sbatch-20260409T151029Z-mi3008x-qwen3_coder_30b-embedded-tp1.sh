...
#SBATCH --output=/work1/talati/yichaoy/vllm-otel/servers/servers-amdhpc-mi3008x-embedded-TP1-0/logs/slurm.%j.out
#SBATCH --error=/work1/talati/yichaoy/vllm-otel/servers/servers-amdhpc-mi3008x-embedded-TP1-0/logs/slurm.%j.err
#SBATCH --nodes=1
...
export EXPERIMENT_SCRIPT=/work1/talati/yichaoy/vllm-otel/experiments/amd-embeded/servers-amdhpc-mi3008x-embedded-TP1-0/sweep-qps-docker-power-clean-amd/generated/20260409T151002Z/run_replay.sh
...
bash /work1/talati/yichaoy/vllm-otel/servers/servers-amdhpc-mi3008x-embedded-TP1-0/start-services.sh
