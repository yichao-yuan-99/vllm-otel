#!/usr/bin/env python3
"""Unit tests for the mi3001x embedded TP1 sbatch renderer."""
...
from launch import Mi3001xEmbeddedTp1Launcher, LaunchError  # type: ignore[import-not-found]
...
class Mi3001xEmbeddedTp1LauncherTest(unittest.TestCase):
    ...
    def test_render_writes_simple_mi3001x_sbatch_wrapper(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            root = Path(tmpdir)
            start_script = self._write_start_script(root)
            launcher = Mi3001xEmbeddedTp1Launcher(
            ...
            self.assertEqual(rendered["partition"], "mi3001x")
            ...
            self.assertEqual(rendered["time_limit"], "08:30:00")
            ...
            self.assertIn("#SBATCH --partition=mi3001x", script_text)
