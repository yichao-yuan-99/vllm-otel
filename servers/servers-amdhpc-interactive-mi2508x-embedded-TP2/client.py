#!/usr/bin/env python3
"""Background control CLI for the interactive AMD HPC embedded TP2 stack."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Background start/stop/status interface for the interactive embedded TP2 stack."
    )
