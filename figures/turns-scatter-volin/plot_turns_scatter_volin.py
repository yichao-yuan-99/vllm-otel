#!/usr/bin/env python3
"""Render the turns-scatter-volin figure from materialized turn-count distributions."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Render the turns-scatter-volin figure from the JSON output of "
    ...
    parser.add_argument(
        "--input",
        required=True,
        help="Input JSON from materialize_turns_scatter_volin.py.",
    )
    parser.add_argument(
        "--output",
        default=None,
        help=(
            ...
            "figures/turns-scatter-volin/output/<input-stem>.pdf"
        ),
    )
    parser.add_argument(
        "--y-scale",
    ...
    parser.add_argument(
        "--title",
        default="Turn Count Distribution by Benchmark and Agent (Violin + Boxplot)",
        help="Figure title.",
    )
    parser.add_argument(
        "--figure-width",
    ...
    parser.add_argument(
        ...
        type=float,
        default=8.8,
        help="Figure height in inches (default: 8.8).",
    )
    parser.add_argument(
        "--jitter-width",
        type=float,
