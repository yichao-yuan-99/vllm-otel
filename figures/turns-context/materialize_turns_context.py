#!/usr/bin/env python3
"""Materialize per-job max-context distributions for the turns-context figure."""
...
DEFAULT_OUTPUT_STEM = "turns-context"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Materialize per-job max-context distributions for the turns-context "
            "figure from run-stats/run-stats-summary.json files."
        )
    )
    parser.add_argument(
        "--root-dir",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "figures/turns-context/data/"
            "turns-context.<root>.benchmarks-<...>.agents-<...>.json"
        ),
    )
...
def main() -> int:
    ...
    materialized_payload = {
        ...
        "figure_title": "Maximum Context Usage Distribution by Benchmark and Agent",
