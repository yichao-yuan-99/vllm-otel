...
MATERIALIZE_SCRIPT = REPO_ROOT / "figures" / "turns-context" / "materialize_turns_context.py"
PLOT_SCRIPT = REPO_ROOT / "figures" / "turns-context" / "plot_turns_context.py"
...
class TurnsContextFigureTest(unittest.TestCase):
    def test_materialize_turns_context_builds_expected_panels(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            output_path = tmp_path / "turns-context.json"
            subprocess.run(
                [
                    sys.executable,
            ...
            self.assertEqual(payload["figure_name"], "turns-context")
    ...
    def test_plot_turns_context_writes_output(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            input_path = tmp_path / "turns-context.json"
            output_path = tmp_path / "turns-context.png"
            subprocess.run(
                [
                    sys.executable,
                    str(MATERIALIZE_SCRIPT),
