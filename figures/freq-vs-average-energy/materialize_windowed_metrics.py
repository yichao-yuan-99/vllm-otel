#!/usr/bin/env python3
"""Materialize frequency-sweep energy/throughput metrics for one time window."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Materialize a per-frequency CSV for the freq-vs-average-energy figure. "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "figures/freq-vs-average-energy/data/"
