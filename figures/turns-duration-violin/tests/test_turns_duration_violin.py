...
class TurnsDurationViolinFigureTest(unittest.TestCase):
    def test_materialize_turns_duration_violin_builds_expected_panels(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            output_path = tmp_path / "turns-duration-violin.json"
            subprocess.run(
                [
                    sys.executable,
            ...
            self.assertEqual(payload["figure_name"], "turns-duration-violin")
    ...
    def test_plot_turns_duration_violin_writes_output(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            input_path = tmp_path / "turns-duration-violin.json"
            output_path = tmp_path / "turns-duration-violin.png"
            subprocess.run(
                [
                    sys.executable,
                    str(MATERIALIZE_SCRIPT),
