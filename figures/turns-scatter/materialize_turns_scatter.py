#!/usr/bin/env python3
"""Materialize per-job turn-count distributions for the turns-scatter figure."""
...
DEFAULT_OUTPUT_STEM = "turns-scatter"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Materialize per-job turn-count distributions for the turns-scatter figure "
            "from run-stats/run-stats-summary.json files."
        )
    )
    parser.add_argument(
        "--root-dir",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "figures/turns-scatter/data/"
            "turns-scatter.<root>.benchmarks-<...>.agents-<...>.json"
        ),
    )
...
def main() -> int:
    ...
    materialized_payload = {
        ...
        "figure_title": "Turn Count Distribution by Benchmark and Agent",
        "metric_name": "turns",
