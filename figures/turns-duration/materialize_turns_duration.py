#!/usr/bin/env python3
"""Materialize per-job agent-duration distributions for the turns-duration figure."""
...
DEFAULT_OUTPUT_STEM = "turns-duration"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Materialize per-job agent-duration distributions for the turns-duration "
            "figure from gateway lifecycle artifacts in the latest selected runs."
        )
    )
    parser.add_argument(
        "--root-dir",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "figures/turns-duration/data/"
            "turns-duration.<root>.benchmarks-<...>.agents-<...>.json"
        ),
    )
...
def main() -> int:
    ...
    materialized_payload = {
        ...
        "figure_title": "Agent Duration Distribution by Benchmark and Agent",
