#!/usr/bin/env python3
"""Linespace GPU frequency controller driven by gateway context usage."""
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="freq-controller-linespace",
        description=(
            "Control GPU core frequency from gateway context usage using a "
            "single linespace threshold and zeusd."
        ),
    )
    parser.add_argument(
        "--config",
    ...
    try:
        ...
        print(
            (
                "freq-controller-linespace logs: "
